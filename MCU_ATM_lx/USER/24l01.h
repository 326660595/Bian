...
#define NRF24L01_CSN_SET GPIO_SetBits(GPIOG,GPIO_Pin_7)
#define NRF24L01_CSN_CLR GPIO_ResetBits(GPIOG,GPIO_Pin_7)

  
#define NRF24L01_IRQ  GPIO_ReadInputDataBit(GPIOG,GPIO_Pin_8)  //IRQ主机数据输入
